...
import trainData.displayTrainList;

public class noResult extends javax.swing.JFrame {
    public noResult() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("or no direct route available to the destination ");

        jLabel8.setFont(new java.awt.Font("Calibri", 1, 18));
        jLabel8.setText("Your input is misspelled,");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/media/noresult.jpg")));
